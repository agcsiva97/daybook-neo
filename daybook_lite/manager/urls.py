...
urlpatterns = [
    ...
    path('shops/<str:pk>/accounts/', views.shop_info, name='shop_info'),
    ...
    path('shops/<str:pk>/balance_sheet', views.balance_sheet_shop, name='shop_balance_sheet'),
    path('shops/<str:pk>/acc_type/<str:type_pk>/', views.account_balance_sheet, name='type_balance_sheet'),
    ...
    path('accounts/<str:pk>/delete-transactions/', views.delete_transactions, name='delete_transactions'),
